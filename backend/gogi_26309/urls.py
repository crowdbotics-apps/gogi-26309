...
admin.site.site_header = "Gogi"
admin.site.site_title = "Gogi Admin Portal"
admin.site.index_title = "Gogi Admin"

# swagger
api_info = openapi.Info(
    title="Gogi API",
    default_version="v1",
    description="API documentation for Gogi App",
)
